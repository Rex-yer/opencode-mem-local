...
function buildConfig(fileConfig: OpenCodeMemConfig) {
  ...
  return {
    ...
    embeddingAllowRemoteModels:
      fileConfig.embeddingAllowRemoteModels ?? DEFAULTS.embeddingAllowRemoteModels,
    ...
    logLevel: (fileConfig.logLevel ?? DEFAULTS.logLevel) as "debug" | "info" | "warn" | "error",
    memory: {
